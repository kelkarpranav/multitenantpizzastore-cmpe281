  ...
  <body>
	...
	<div class="row offset2 span8">
		<div class="text-center">
			<img src="resources/imgs/papajohnsimgs/homelogo.png" alt="" style="float:left">
			<h1 style="padding-top:30px">Welcome to Papa Johns!</h1>
		</div>
	</div>
   <div class="row offset2 span8" >
		 <div class="navbar">
                ...
                <div class="container">
                  <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                    ...
                    <ul class="nav pull-right">
                      <li><a href="<c:url value="/papajohns"/>">Home</a></li>
     ...
     <div id="content">
      ...
      <footer>
        <div class="row text-center">
          <div class="col-lg-12">
            <p>Copyright &copy; 2013 Papa John's International, Inc. All Rights Reserved.</p>
          </div>
        </div>
      </footer>
