  ...
  <head>
   ...
   <script src='resources/js/jquery.js' type="text/javascript"></script>
	...
	var catalog = {
					...
					"pizzas":[
								{"Name": "Wisconsin 6 Cheese Pizza Small", "Price": "$5.00"},
								{"Name": "Wisconsin 6 Cheese Pizza Medium", "Price": "$8.00"},
								{"Name": "Chicken & Bacon Carbonara X-Large", "Price": "$14.00"}],
					"sides": [
								{"Name": "Italian", "Price": "$6.00"},
								{"Name": "Wings", "Price": "$6.00"}]
					}
  ...
  <body>
	...
	<div class="row offset2 span8">
		<div class="text-center">r
			<img src="resources/imgs/roundtableimgs/homelogo.png" alt="" style="float:left">
			<h1 style="padding-top:30px">Welcome to Round Table Pizza!</h1>
		</div>
	</div>
   <div class="row offset2 span8" >
		 <div class="navbar">
                ...
                <div class="container">
                  <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                    ...
                    <ul class="nav pull-right">
                      <li><a href="<c:url value="/roundtable"/>">Home</a></li>
        ...
        <div id="content">
		  <div class="alert alert-success text-center">Pizzas</div>
		  <ul id="pizzalist"></ul>
		   <div class="alert alert-success text-center">Drinks</div>
		  <ul id="drinkslist"></ul>
		  <div class="alert alert-success text-center">Sides</div>
		  <ul id="sideslist"></ul>
      ...
      <footer>
        <div class="row text-center">
          <div class="col-lg-12">
            <p>Copyright &copy; 2013 Round Table Pizza</p>
          </div>
        </div>
      </footer>
