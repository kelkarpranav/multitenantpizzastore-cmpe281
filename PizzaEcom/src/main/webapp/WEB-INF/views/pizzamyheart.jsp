  ...
  <body>
	...
	<div class="row offset2 span8">
		<div class="text-center">
			<img src="resources/imgs/pizzamyheartimgs/homelogo.png" alt="" style="float:left">
			<h1 style="padding-top:30px">Welcome to Pizza My Heart!</h1>
		</div>
	</div>
   <div class="row offset2 span8" >
		 <div class="navbar">
                ...
                <div class="container">
                  <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                    ...
                    <ul class="nav pull-right">
                      <li><a href="<c:url value="/pizzamyheart"/>">Home</a></li>
      ...
      <footer>
        <div class="row text-center">
          <div class="col-lg-12">
            <p>Copyright &copy; 2013 Pizza My Heart</p>
          </div>
        </div>
      </footer>
