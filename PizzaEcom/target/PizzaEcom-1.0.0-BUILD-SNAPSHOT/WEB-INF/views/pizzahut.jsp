...
<html lang="en">
  ...
  <body>
	...
	<div class="row offset2 span8">
		<div class="text-center" style="background-color:#780000">
			<img src="resources/imgs/pizzahutimgs/homelogo.png" alt="" style="float:left">
			<h1 style="padding-top:30px; color:#fff">Welcome to Pizza Hut!</h1>
		</div>
	</div>
   <div class="row offset2 span8" >
		 <div class="navbar">
              <div class="navbar-inner">
                <div class="container">
                  <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                    ...
                    <ul class="nav">
                      <li><a href="<c:url value="/pizzahut"/>">Home</a></li>
       ...
       <div id="content">
		  <div class="alert alert-error text-center">Pizzas</div>
		  <ul id="pizzalist"></ul>
		   <div class="alert alert-error text-center">Drinks</div>
		  <ul id="drinkslist"></ul>
		  <div class="alert alert-error text-center">Sides</div>
		  <ul id="sideslist"></ul>
      ...
      <footer>
        <div class="row text-center">
          <div class="col-lg-12">
            <p>Copyright &copy; 2013 Pizza Hut, Inc. All rights reserved. Powered by QuikOrder® The Pizza Hut name, logos, and related marks are trademarks of Pizza Hut, Inc.</p>
          </div>
        </div>
      </footer>
